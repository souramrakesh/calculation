...
def predict():
    if request.method == 'POST':
        ...
        if first_number and second_number in "1234567890":
            ...
            return render_template('index1.html', text ="Addition of {} and {} is :{}".format(first_number,second_number,predict))
        else:
            return render_template('index1.html',text ="Please Enter an integer")
